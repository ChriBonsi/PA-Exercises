...
public interface Transaction extends ElementWithId {
     ...
     * correspond to an incoming, otherwise it represents an expense.
     *
    ...
    /**
     * Returns the list of movements involved in these transactions.
     *
     * @return the list of movements involved in these transactions.
     */
